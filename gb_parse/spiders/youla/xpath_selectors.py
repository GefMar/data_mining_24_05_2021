BRANDS = {
    "selector": "//div[contains(@class, 'Filters_brandsList')]" "//a[@data-target='brand']/@href",
    "callback": "brand_parse",
}
PAGINATION = {
    "selector": "//div[contains(@class, 'Paginator_block')]" "//a[@data-target-id='button-link-serp-paginator']/@href",
    "callback": "brand_parse",
}

CARS = {
    "selector": "//article[@data-target='serp-snippet']" "//a[@data-target='serp-snippet-title']/@href",
    "callback": "car_parse",
}
...
CAR_DATA = {
    ...
    "characteristics": {
        "xpath": "//div[contains(@class, 'AdvertCard_specs')]" "/div/div[contains(@class, 'AdvertSpecs_row')]"
    },
